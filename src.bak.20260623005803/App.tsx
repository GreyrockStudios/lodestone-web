...
// Tauri 2 injects __TAURI_INTERNALS__ before page scripts.
...
export default function App() {
  ...
  return (
    <Routes>
      {/* Desktop app: only app routes, no marketing */}
      {isTauri ? (
        <>
          ...
          {user && (
            <>
              ...
              <Route path="/identity" element={<Navigate to="/chat" replace />} />
