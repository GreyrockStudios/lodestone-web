...
const billing: FaqItem[] = [
  {
    ...
    a: 'Community is free forever. You get Ollama Cloud access, memory, /recall, tasks, streaming, and templates — no credit card needed. Usage is billed at actual provider cost + 5%.',
  },
  {
    q: 'What does "usage billed at cost + 5%" mean?',
    a: 'When you use a provider (like OpenAI or Anthropic), we pass through their actual cost plus a 5% markup. If GPT-4o costs $0.005 per 1K tokens, you pay $0.00525. No hidden fees, no monthly minimums beyond your included usage.',
  },
  {
