      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-[var(--text-muted)] leading-relaxed text-[15px]">
          <section>
            ...
            <p>By accessing or using Lodestone ("Service"), operated by Greyrock Studio ("Company," "we," "us"), you agree to be bound by these Terms of Service. If you do not agree, do not use the Service. These terms apply to both the web application and the desktop application.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">You must be at least 13 years old to create an account. If you are under 18, you must have parental consent.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-[var(--text)] mb-3">3. Service Tiers</h2>
            <p className="mb-3">Lodestone is offered in the following tiers:</p>
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-[var(--surface)] border border-[var(--border)]">
                <h3 className="font-semibold text-[var(--text)] mb-1">Free Tier</h3>
                <p>Limited chat access with local models via Ollama only. You provide your own compute and API keys. No payment required. Subject to usage limits that may change at our discretion.</p>
              </div>
              <div className="p-4 rounded-lg bg-[var(--surface)] border border-[var(--border)]">
                <h3 className="font-semibold text-[var(--text)] mb-1">Desktop Tier ($9.99/month)</h3>
                <p>Full desktop application with unlimited conversations, memory, knowledge graph, tools, and multi-provider support (Ollama, OpenAI, Anthropic, Groq). Billed monthly.</p>
              </div>
              <div className="p-4 rounded-lg bg-[var(--surface)] border border-[var(--border)]">
                <h3 className="font-semibold text-[var(--text)] mb-1">Pro Tier ($19.99/month)</h3>
                <p>Everything in Desktop plus advanced tools, priority support, API access, custom agent personalities, multi-agent workflows, and team sharing. Billed monthly.</p>
              </div>
            </div>
            <p className="mt-3">Paid subscriptions are billed in advance on a monthly basis. Prices may change with 30 days' notice.</p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">The Service and its original content, features, and functionality are owned by Greyrock Studio and are protected by international copyright, trademark, and other intellectual property laws.</p>
            <p><strong className="text-[var(--text)]">Your content:</strong> You retain ownership of all content you input into the Service. By using the Service, you grant us a limited license to process your content solely to provide the Service. We do not use your content to train AI models.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-[var(--text)] mb-3">6. Open Source Components</h2>
            <p>The Lodestone desktop application is open source under the MIT License and available at <a href="https://github.com/GreyrockStudios/lodestone-desktop" className="text-[var(--cyan)]">github.com/GreyrockStudios/lodestone-desktop</a>. The MIT License applies to the source code. These Terms of Service apply to your use of the hosted Service, cloud features, and paid subscriptions.</p>
          </section>
          ...
          <section>
            ...
            <p>You agree to indemnify and hold harmless Greyrock Studio, its officers, directors, employees, and agents from any claims, damages, losses, or expenses arising from your use of the Service or violation of these Terms.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-[var(--text)] mb-3">10. Termination</h2>
            <p className="mb-3">We may terminate or suspend your account at our discretion, with or without notice, for conduct that violates these Terms or is harmful to other users or the Service.</p>
          ...
          <section>
            ...
            <p>We may modify these Terms at any time. Material changes will be notified via email or in-Service notice at least 30 days before taking effect. Continued use of the Service after changes become effective constitutes acceptance of the modified Terms.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-[var(--text)] mb-3">12. Governing Law</h2>
            <p>These Terms are governed by the laws of the Province of Ontario and the federal laws of Canada applicable therein. Any disputes shall be resolved in the courts of Ottawa, Ontario, Canada.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-[var(--text)] mb-3">13. Contact</h2>
            <p>For questions about these Terms, contact us at <a href="mailto:legal@heylodestone.com" className="text-[var(--cyan)]">legal@heylodestone.com</a>.</p>
          </section>
