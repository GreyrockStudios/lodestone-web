...
const plans = [
  {
    ...
    features: [
      ...
      { name: '$10/mo usage included', included: true },
...
const featureRows = [
  ...
  { feature: 'Usage included', community: '$10/mo', pro: '$15/mo', studio: '$40/mo' },
    ...
    <div className="min-h-screen bg-[var(--bg)] py-20 px-4">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-[var(--text-dim)] mt-2">Usage billed at cost + 5%. Bring your own key to bypass usage charges entirely.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center mb-12">
          ...
          <div className="p-6 rounded-xl bg-[var(--surface)] border border-[var(--border)]">
            <div className="text-3xl mb-3">💰</div>
            <h3 className="font-semibold text-[var(--text)] mb-2">Pay for what you use</h3>
            <p className="text-sm text-[var(--text-muted)]">Usage is billed at actual provider cost + 5%. No markup on model access. Bring your own key and pay nothing to us.</p>
          </div>
          <div className="p-6 rounded-xl bg-[var(--surface)] border border-[var(--border)]">
            <div className="text-3xl mb-3">🧠</div>
        ...
        <div className="space-y-4 mb-8">
          ...
          {[
            ...
            { q: 'What does "usage billed at cost + 5%" mean?', a: 'When you use a provider like OpenAI or Anthropic, we pass through their actual cost plus a 5% markup. If GPT-4o costs $0.005 per 1K tokens, you pay $0.00525. No hidden fees, no monthly minimums.' },
