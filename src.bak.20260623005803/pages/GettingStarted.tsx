...
Which direction fits your product?" />
          ...
          <div className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Set expectations.</strong> "Be concise" or "Explain like I'm a senior engineer" — it adapts its style.</li>
              ...
              <li><strong>Upload files.</strong> Drag a file into chat or click the attach button to add context from documents.</li>
              <li><strong>Check Memory.</strong> Visit the Memory tab to see what your agent has learned about you.</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className="space-y-4 text-[var(--text-muted)] leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
            {[
              ...
              { icon: "📎", title: "File uploads", desc: "Drop files into chat. Your agent reads them and stores key facts in memory." },
              { icon: "💬", title: "Conversation sharing", desc: "Share any conversation with a unique link. No login required for viewers." },
              { icon: "⚡", title: "Streaming responses", desc: "See tokens appear in real-time. No waiting for the full response." },
      ...
      <section className="mb-10">
        ...
        <div className="space-y-4 text-[var(--text-muted)] leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
            {[
              { name: "Community", price: "$0", color: "text-[var(--text-muted)]", features: ["Ollama Cloud", "Memory & /recall", "Tasks & commitments", "$10/mo usage included", "Streaming responses"] },
