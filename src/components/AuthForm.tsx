            ...
            <div className="mt-4">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-[var(--surface-2)] px-2 text-[var(--text-dim)]">or continue with</span>
                </div>
              </div>
              <div className="mt-3 grid grid-cols-2 gap-3">
                <a
                  href="/api/auth/google"
                  className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-[var(--border)] bg-[var(--surface)] text-[var(--text)] hover:bg-[var(--surface-2)] transition-colors text-sm no-underline"
                >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="mt-4">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-[var(--surface-2)] px-2 text-[var(--text-dim)]">or sign up with</span>
                </div>
              </div>
              <div className="mt-3 grid grid-cols-2 gap-3">
                <a
